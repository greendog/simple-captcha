...
{<img src="https://travis-ci.org/pludoni/simple-captcha.png?branch=master" alt="Build Status" />}[https://travis-ci.org/pludoni/simple-captcha]
...
* {Rails}[http://github.com/rails/rails] >= 3.2
...
==Installation
  ...
  gem 'simple_captcha2', :git => 'git://github.com/pludoni/simple-captcha.git'
